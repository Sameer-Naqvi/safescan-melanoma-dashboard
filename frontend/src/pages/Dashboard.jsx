    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <main className="max-w-6xl mx-auto px-8 py-8 grid grid-cols-3 gap-8">
        <div className="col-span-1 space-y-6">
          <UploadPanel onResult={(data) => setResults((prev) => [...prev, data])} />
        ...
        <div className="col-span-2">
          <h2 className="text-slate-300 font-semibold mb-4">Scan History <span className="ml-2 text-slate-500 text-sm font-normal">{results.length} processed</span></h2>
